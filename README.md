...
**Inkscape Basics**: We learn to navigate and use some basic tools and functions
  ...
  - Adjust Page size and units, e.g. poster vs. manuscript figure (File > Document Properties). *Note: some journals have detailed [guidelines](https://www.cell.com/figureguidelines).*
