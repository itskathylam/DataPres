...
- Take 5 minutes examine the figure, looking carefully look at each panel individually as well as the figure as a whole
- Write down 3 things that you think could be improved. *Remember: The goal is not to deride the figure but to try to objectively improve it to help convey the science in a clear, easily readable way.*
